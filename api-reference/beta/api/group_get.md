...
Since the **group** resource supports [extensions](/graph/extensibility_overview), you can also use the `GET` operation to get custom properties and extension data in a **group** instance.
