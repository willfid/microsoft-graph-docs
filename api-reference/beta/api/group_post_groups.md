...
Since the **group** resource supports [extensions](/graph/extensibility_overview), you can use the `POST` operation and add custom properties with your own data to the group while creating it.
