...
Since the **group** resource supports [extensions](/graph/extensibility_overview), you can use the `PATCH` operation to add, update, or delete your own app-specific data in custom properties of an extension in an existing **group** instance.
