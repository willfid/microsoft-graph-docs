...
|scope|String| Specifies the value of the [scope](/graph/permissions_reference) claim that the resource application should expect in the OAuth 2.0 access token. For example, *User.Read* |
