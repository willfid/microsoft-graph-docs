...
Get newly created, updated, or deleted directory roles without having to perform a full read of the entire resource collection. See [Using Delta Query](/graph/delta_query_overview) for details.
...
- [Use delta query to track changes in Microsoft Graph data](/graph/delta_query_overview) for more details
- [Get incremental changes for users](/graph/delta_query_users) for an example requests.
