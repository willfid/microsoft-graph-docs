...
Since the **event** resource supports [extensions](/graph/extensibility_overview), you can use the `POST` operation and add custom properties with your own data to the event while creating it.
